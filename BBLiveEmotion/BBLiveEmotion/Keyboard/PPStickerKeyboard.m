...
static CGFloat const PPStickerTopInset = 30.0;
static CGFloat const PPStickerScrollViewHeight = 154.0;
static CGFloat const PPKeyboardPageControlTopMargin = 26.0;
static CGFloat const PPKeyboardPageControlHeight = 7.0;
static CGFloat const PPKeyboardPageControlBottomMargin = 27.0;
static CGFloat const PPKeyboardCoverButtonWidth = 50.0;
static CGFloat const PPKeyboardCoverButtonHeight = 44.0;
static CGFloat const PPPreviewViewWidth = 65.0;
static CGFloat const PPPreviewViewHeight = 128.0;
...
//        self.queuingScrollView.backgroundColor = [UIColor purpleColor];
...
- (void)stickerPageView:(PPStickerPageView *)stickerKeyboard showEmojiPreviewViewWithEmoji:(PPEmoji *)emoji buttonFrame:(CGRect)buttonFrame
{
    ...
    self.emojiPreviewView.frame = CGRectMake(CGRectGetMidX(buttonFrameAtKeybord) - PPPreviewViewWidth / 2, UIScreen.mainScreen.bounds.size.height - CGRectGetHeight(self.bounds) + CGRectGetMaxY(buttonFrameAtKeybord) - PPPreviewViewHeight + 15.f, PPPreviewViewWidth, PPPreviewViewHeight);

...
static CGFloat PPEmojiPreviewImageTopPadding = 8.0;
static CGFloat PPEmojiPreviewImageLeftRightPadding = 10.0;
static CGFloat PPEmojiPreviewImageLength = 45.0;
...
{
    if (self = [super init]) {
        self.image = BBLiveEmotionImage(@"bg_changan");
...
- (void)layoutSubviews
{
    ...
    self.emojiImageView.image = BBLiveEmotionImage(self.emoji.imageName);
...
- (UILabel *)descriptionLabel
{
    if (!_descriptionLabel) {
        ...
        _descriptionLabel.textColor = [UIColor pp_colorWithRGBString:@"#333333"];

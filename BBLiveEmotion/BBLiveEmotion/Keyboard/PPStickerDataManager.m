...
- (void)initStickers
{
    NSString *plistPath = @"BBLiveEmotionResource.bundle/EmotionInfo";
//    NSString *plistPath = @"BBLiveEmotionResource.bundle/InnerStickersInfo";
...
//            emojiSubString = [emojiSubString substringWithRange:NSMakeRange(0, emojiSubString.length - 1)];    // 去掉]
            ...
            if (emoji) {
                ...
                emojiMatchingResult.emojiImage = BBLiveEmotionImage(emoji.imageName);

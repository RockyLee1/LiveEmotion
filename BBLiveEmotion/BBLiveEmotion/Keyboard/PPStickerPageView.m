...
static CGFloat const PPStickerPageViewEmojiButtonLength = 30.0;
static CGFloat const PPStickerPageViewEmojiButtonVerticalMargin = 32.0;
...
- (UIButton *)deleteButton
{
    if (!_deleteButton) {
        ...
        [_deleteButton setImage:BBLiveEmotionImage(@"icon_delete") forState:UIControlStateNormal];
...
- (UIImage *)emojiImageWithName:(NSString *)name
{
    ...
    return BBLiveEmotionImage(name);
    
//    UIImage *image = [UIImage imageNamed:[@"BBLiveEmotionResource.bundle/Sticker.bundle" stringByAppendingPathComponent:name]];
//    return image;
}
